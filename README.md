...
**AI-powered freight brokerage platform that dispatches voice agents to call trucking carriers, negotiate rates, and deliver real-time quotes — so brokers never have to pick up a phone.**
...
- **Real-time Dashboard** — quotes and call statuses update live via Server-Sent Events (no refresh needed)
- **Carrier Management** — add carriers manually or bulk import via CSV
